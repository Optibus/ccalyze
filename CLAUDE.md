...
- `src/report.ts` — renders the habits report as one self-contained HTML page (written on every `--habits` run)
...
The report page renders that same report object and nothing else: the page embeds the JSON the run
